            ...
            <div class="flex">
                <div class="box">
                    ...
                    <p>
                        ...
                        Agrega una sección para cada uno de los ítems de hospedaje, 
                        gastronomía, biodiversidad, artesanías y atractivos turísticos.
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="input_type" style="width: 100%">
                    ...
                    >
                        <select id="category" v-model="section">
                            ...
                            <option >Atractivos Turísticos</option>
                        </select>
...
export default {
    ...
    methods: {
        ...
        submit() {
            ...
            if(this.title == '' || this.title.length == 0) return this.$root.showNotify('error', 'Necesitas agregar el título');
            if(this.desc == '' || this.desc.length == 0) return this.$root.showNotify('error', 'Necesitas agregar descripción');
            if(this.details == '' || this.desc.length == 0) return this.$root.showNotify('error', 'Necesitas agregar detalles');
            if(this.location == '' || this.desc.length == 0) return this.$root.showNotify('error', 'Necesitas agregar ubicación');
            if(this.contact == '' || this.desc.length == 0) return this.$root.showNotify('error', 'Necesitas agregar contacto');
